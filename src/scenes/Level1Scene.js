...
export class Level1Scene extends Phaser.Scene {
  ...
  create() {
    // this.events sobrevive a scene.restart(); limpa listeners antigos para evitar duplicatas.
  ...
  update(time, delta) {
    ...
    // Efeito de náusea: rotação + zoom suave enquanto o timer estiver ativo
    ...
    // blocked.down só é true sobre piso sólido, nunca sobre buraco
