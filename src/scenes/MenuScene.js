...
export class MenuScene extends Phaser.Scene {
  ...
  init(data) {
    ...
    // Modo Dev (acessado pelo seletor de fase em Créditos): dá invencibilidade
    // ao jogador nas cenas de fase para facilitar os testes sem precisar morrer.
  ...
  _confirm() {
    ...
    this.time.delayedCall(140, () => this.scene.start(this.targetScene, { char: chosen, devMode: this.devMode }));
  }
}
